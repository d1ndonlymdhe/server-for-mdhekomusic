...
class BaseVideo extends _1.Base {
    ...
    load(data) {
        ...
        this.likeCount = (0, common_1.stripToInt)(BaseVideo.parseButtonRenderer(topLevelButtons[0]));
        this.dislikeCount = (0, common_1.stripToInt)(BaseVideo.parseButtonRenderer(topLevelButtons[1]));
        ...
        if (secondaryContents) {
            ...
            this.relatedContinuation = (0, common_1.getContinuationFromItems)(secondaryContents);
        }
        else {
            this.upNext = null;
            this.related = [];
