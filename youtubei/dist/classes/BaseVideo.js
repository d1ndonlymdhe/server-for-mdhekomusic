...
class BaseVideo extends _1.Base {
  ...
  load(data) {
    ...
    // Channel
    const { title, thumbnail, subscriberCountText } =
      videoInfo.owner.videoOwnerRenderer;
    this.channel = new _1.ChannelCompact({
      client: this.client,
      id: title.runs[0].navigationEndpoint.browseEndpoint.browseId,
      name: title.runs[0].text,
      subscriberCount:
        subscriberCountText === null || subscriberCountText === void 0
          ? void 0
    ...
    this.likeCount = (0, common_1.stripToInt)(
      BaseVideo.parseButtonRenderer(topLevelButtons[0])
    );
    this.dislikeCount = (0, common_1.stripToInt)(
    ...
    if (secondaryContents) {
      ...
      this.relatedContinuation = (0, common_1.getContinuationFromItems)(
        secondaryContents
      );
    } else {
      this.upNext = null;
